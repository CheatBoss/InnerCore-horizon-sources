...
{
    @Override
    public List<Card> handleCardUpdate(final ContentCardsUpdatedEvent contentCardsUpdatedEvent) {
        final List<Card> allCards = contentCardsUpdatedEvent.getAllCards();
        Collections.sort((List<Object>)allCards, (Comparator<? super Object>)new Comparator<Card>() {
            @Override
