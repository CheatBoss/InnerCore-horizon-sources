...
public final class Dops
{
    ...
    public static Dop get(final int n) {
        try {
            final Dop dop = Dops.DOPS[n + 1];
            if (dop != null) {
                return dop;
            }
        }
    ...
    public static Dop getNextOrNull(final Dop dop, final DexOptions dexOptions) {
        final int nextOpcode = dop.getNextOpcode();
        if (nextOpcode == -1) {
            return null;
        }
    ...
    private static void set(final Dop dop) {
        Dops.DOPS[dop.getOpcode() + 1] = dop;
    }
}
