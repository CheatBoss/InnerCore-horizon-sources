...
public final class RopToDop
{
    ...
    public static Dop dopFor(final Insn insn) {
        ...
        final Dop dop = RopToDop.MAP.get(opcode);
        if (dop != null) {
            return dop;
        }
            ...
            if (opcode2 != 57) {
                Label_0505: {
                    switch (opcode2) {
                            ...
                            switch (opcode2) {
                                default: {
                                    switch (opcode2) {
                                        ...
                                        case 48: {
                                            final int basicType = ((CstFieldRef)((ThrowingCstInsn)insn).getConstant()).getBasicType();
                                            if (basicType == 6) {
                                                return Dops.SPUT;
                                            }
                                            if (basicType == 8) {
                                        ...
                                        case 47: {
                                            final int basicType2 = ((CstFieldRef)((ThrowingCstInsn)insn).getConstant()).getBasicType();
                                            if (basicType2 == 6) {
                                                return Dops.IPUT;
                                            }
                                            if (basicType2 == 8) {
                                        ...
                                        case 46: {
                                            final int basicType3 = ((CstFieldRef)((ThrowingCstInsn)insn).getConstant()).getBasicType();
                                            if (basicType3 == 6) {
                                                return Dops.SGET;
                                            }
                                            if (basicType3 == 8) {
                                        ...
                                        case 45: {
                                            final int basicType4 = ((CstFieldRef)((ThrowingCstInsn)insn).getConstant()).getBasicType();
                                            if (basicType4 == 6) {
                                                return Dops.IGET;
                                            }
                                            if (basicType4 == 8) {
                        ...
                        case 5: {
                            final Constant constant = ((ThrowingCstInsn)insn).getConstant();
