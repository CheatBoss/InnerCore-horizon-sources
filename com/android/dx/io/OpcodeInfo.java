...
public final class OpcodeInfo
{
    ...
    public static Info get(final int n) {
        try {
            final Info info = OpcodeInfo.INFO[n + 1];
            if (info != null) {
                return info;
            }
        }
        ...
        sb.append(Hex.u2or4(n));
        throw new IllegalArgumentException(sb.toString());
    }
    
    public static InstructionCodec getFormat(final int n) {
        return get(n).getFormat();
    }
    
    public static IndexType getIndexType(final int n) {
        return get(n).getIndexType();
    }
    ...
    private static void set(final Info info) {
        OpcodeInfo.INFO[info.getOpcode() + 1] = info;
    }
