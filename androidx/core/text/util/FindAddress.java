...
class FindAddress
{
    ...
    private static boolean isValidZipCode(final String s, final MatchResult matchResult) {
        ...
        boolean b2 = b;
        if (FindAddress.sZipCodeRe.matcher(s).matches()) {
            b2 = b;
            if (FindAddress.sStateZipCodeRanges[n].matches(s)) {
                b2 = true;
            }
        }
        return b2;
    ...
    private static class ZipRange
    {
        ...
        boolean matches(final String s) {
            ...
            return (this.mLow <= int1 && int1 <= this.mHigh) || int1 == this.mException1 || int1 == this.mException2;
        }
    }
}
