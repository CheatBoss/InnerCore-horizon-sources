...
public class SecT131R1Point extends AbstractF2m
{
            ...
            if (!add2.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (ecFieldElement3.isZero()) {
                        return new SecT131R1Point(curve, ecFieldElement3, curve.getB().sqrt(), this.withCompression);
                    }
                ...
                return new SecT131R1Point(curve, ecFieldElement3, ecFieldElement4, new ECFieldElement[] { fromBigInteger }, this.withCompression);
            }
            if (add.isZero()) {
                return this.twice();
            }
    ...
    public ECPoint twice() {
        ...
        return new SecT131R1Point(curve, square2, multiply3.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[] { multiply2 }, this.withCompression);
    }
