            ...
            if (!add2.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (ecFieldElement3.isZero()) {
                        return new SecT409R1Point(curve, ecFieldElement3, curve.getB().sqrt(), this.withCompression);
                    }
                ...
                return new SecT409R1Point(curve, ecFieldElement3, ecFieldElement4, new ECFieldElement[] { fromBigInteger }, this.withCompression);
            }
            if (add.isZero()) {
                return this.twice();
            }
