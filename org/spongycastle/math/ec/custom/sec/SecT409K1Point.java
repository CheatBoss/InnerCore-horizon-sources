...
public class SecT409K1Point extends AbstractF2m
{
    ...
    public ECPoint add(final ECPoint ecPoint) {
        ...
        if (ecFieldElement.isZero()) {
            ...
            if (!add2.isZero()) {
                ...
                return new SecT409K1Point(curve, ecFieldElement3, ecFieldElement4, new ECFieldElement[] { fromBigInteger }, this.withCompression);
            }
            if (add.isZero()) {
                return this.twice();
            }
    ...
    public ECPoint twice() {
        ...
        return new SecT409K1Point(curve, square3, square4.add(ecFieldElement).add(square2).multiply(square4).add(square).add(square3).add(multiply), new ECFieldElement[] { multiply }, this.withCompression);
    }
