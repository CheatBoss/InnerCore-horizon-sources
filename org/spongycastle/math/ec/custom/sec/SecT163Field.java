...
public class SecT163Field
{
    ...
    protected static void implMultiply(long[] array, final long[] array2, final long[] array3) {
        final long n = array[0];
        final long n2 = array[1];
        final long n3 = array[2] << 18 ^ n2 >>> 46;
        final long n4 = (n2 << 9 ^ n >>> 55) & 0x7FFFFFFFFFFFFFL;
        ...
        final long n23 = n20 ^ (n15 ^ n16 << 1 ^ n18) ^ array[3] << 4 ^ array[3] << 1 ^ n22 >>> 55;
        final long n24 = n21 ^ n16 ^ n23 >>> 55;
        final long n25 = n23 & 0x7FFFFFFFFFFFFFL;
        final long n26 = (n22 & 0x7FFFFFFFFFFFFFL) >>> 1 ^ (n25 & 0x1L) << 54;
        ...
        final long n32 = (n31 ^ n31 << 32) & 0x7FFFFFFFFFFFFFL;
        final long n33 = n25 >>> 1 ^ (n24 & 0x1L) << 54 ^ n32 >>> 54;
        ...
        final long n39 = (n38 ^ n38 << 32) & 0x7FFFFFFFFFFFFFL;
        final long n40 = n24 >>> 1 ^ n39 >>> 54;
    ...
    protected static void implMulw(final long n, long n2, final long[] array, final int n3) {
        ...
        long n4 = array2[(int)n & 0x3];
        n2 = 0L;
        int n5 = 47;
        do {
            final int n6 = (int)(n >>> n5);
            final long n7 = array2[n6 >>> 6 & 0x7] << 6 ^ (array2[n6 & 0x7] ^ array2[n6 >>> 3 & 0x7] << 3);
            n4 ^= n7 << n5;
            n2 ^= n7 >>> -n5;
            n5 -= 9;
        } while (n5 > 0);
        array[n3] = (n4 & 0x7FFFFFFFFFFFFFL);
        array[n3 + 1] = (n4 >>> 55 ^ n2 << 9);
    }
    ...
    public static void reduce(final long[] array, final long[] array2) {
        ...
        final long n5 = array[4];
        final long n6 = array[5];
        final long n7 = n4 ^ (n6 >>> 35 ^ n6 >>> 32 ^ n6 >>> 29 ^ n6 >>> 28);
        final long n8 = n3 ^ (n6 << 29 ^ n6 << 32 ^ n6 << 35 ^ n6 << 36) ^ (n5 >>> 28 ^ (n5 >>> 35 ^ n5 >>> 32 ^ n5 >>> 29));
        final long n9 = n8 >>> 35;
        array2[0] = (n ^ (n7 << 29 ^ n7 << 32 ^ n7 << 35 ^ n7 << 36) ^ n9 ^ n9 << 3 ^ n9 << 6 ^ n9 << 7);
        array2[1] = (n2 ^ (n5 << 29 ^ n5 << 32 ^ n5 << 35 ^ n5 << 36) ^ (n7 >>> 28 ^ (n7 >>> 35 ^ n7 >>> 32 ^ n7 >>> 29)));
        array2[2] = (n8 & 0x7FFFFFFFFL);
    }
    ...
    public static void reduce29(final long[] array, final int n) {
        ...
        final long n4 = n3 >>> 35;
        array[n] ^= (n4 << 7 ^ (n4 << 3 ^ n4 ^ n4 << 6));
        array[n2] = (n3 & 0x7FFFFFFFFL);
    }
