...
public class SecT163K1Point extends AbstractF2m
{
        ...
        if (ecFieldElement.isZero()) {
            ...
            if (!add2.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    ecFieldElement3 = divide.square().add(divide).add(xCoord).addOne();
                    if (ecFieldElement3.isZero()) {
                        return new SecT163K1Point(curve, ecFieldElement3, curve.getB(), this.withCompression);
                    }
                ...
                return new SecT163K1Point(curve, ecFieldElement3, ecFieldElement4, new ECFieldElement[] { fromBigInteger }, this.withCompression);
            }
            if (add.isZero()) {
                return this.twice();
            }
    ...
    public ECPoint twice() {
        ...
        final ECFieldElement square3 = y.add(x).square();
        return new SecT163K1Point(curve, square2, square3.add(add).add(square).multiply(square3).add(square2), new ECFieldElement[] { multiply2 }, this.withCompression);
    }
