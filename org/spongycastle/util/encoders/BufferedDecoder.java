...
public class BufferedDecoder
{
    ...
    public int processByte(final byte b, final byte[] array, int decode) {
        ...
        if (bufOff2 == buf.length) {
            decode = this.translator.decode(buf, 0, buf.length, array, decode);
            this.bufOff = 0;
            return decode;
        }
        return 0;
    ...
    public int processBytes(final byte[] array, int n, int n2, final byte[] array2, final int n3) {
        if (n2 >= 0) {
            ...
            if ((n7 = n2) > n4) {
                ...
                final int n8 = translator.decode(buf2, 0, buf2.length, array2, n3) + 0;
                this.bufOff = 0;
                n2 -= n4;
                n += n4;
                final int n9 = n2 - n2 % this.buf.length;
                n5 = n8 + this.translator.decode(array, n, n9, array2, n3 + n8);
                n7 = n2 - n9;
                n6 = n + n9;
            }
            if (n7 != 0) {
