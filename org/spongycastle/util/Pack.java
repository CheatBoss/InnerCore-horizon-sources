...
public abstract class Pack
{
    ...
    public static short bigEndianToShort(final byte[] array, final int n) {
        return (short)((array[n + 1] & 0xFF) | (array[n] & 0xFF) << 8);
    }
    ...
    public static int[] littleEndianToInt(final byte[] array, int i, final int n) {
        final int[] array2 = new int[n];
        final int n2 = 0;
        int n3 = i;
        for (i = n2; i < n; ++i) {
            array2[i] = littleEndianToInt(array, n3);
            n3 += 4;
        }
        return array2;
    }
    ...
    public static void littleEndianToLong(final byte[] array, int i, final long[] array2, final int n, final int n2) {
        final int n3 = 0;
        int n4 = i;
        for (i = n3; i < n2; ++i) {
            array2[n + i] = littleEndianToLong(array, n4);
            n4 += 8;
        }
    }
    
    public static short littleEndianToShort(final byte[] array, final int n) {
        return (short)((array[n + 1] & 0xFF) << 8 | (array[n] & 0xFF));
    }
    ...
    public static void longToLittleEndian(final long[] array, final int n, final int n2, final byte[] array2, int i) {
        final int n3 = 0;
        int n4 = i;
        for (i = n3; i < n2; ++i) {
            longToLittleEndian(array[n + i], array2, n4);
            n4 += 8;
        }
    }
    ...
    public static void shortToLittleEndian(final short n, final byte[] array, final int n2) {
        array[n2] = (byte)n;
        array[n2 + 1] = (byte)(n >>> 8);
    }
