...
public class ECGOST3410NamedCurves
{
    ...
    static {
        ...
        final BigInteger bigInteger11 = new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639319");
        final BigInteger bigInteger12 = new BigInteger("115792089237316195423570985008687907853073762908499243225378155805079068850323");
        final ECCurve.Fp fp6 = new ECCurve.Fp(bigInteger11, new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639316"), new BigInteger("166"), bigInteger12, ECConstants.ONE);
        ECGOST3410NamedCurves.params.put(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetA, new ECDomainParameters(fp6, fp6.createPoint(new BigInteger("1"), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger12));
