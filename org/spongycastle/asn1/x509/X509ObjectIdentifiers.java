...
public interface X509ObjectIdentifiers
{
    ...
    public static final ASN1ObjectIdentifier id_ad_caIssuers = (id_ad = X509ObjectIdentifiers.id_pkix.branch("48")).branch("2").intern();
    ...
    public static final ASN1ObjectIdentifier id_pe = (id_pkix = new ASN1ObjectIdentifier("1.3.6.1.5.5.7")).branch("1");
    ...
    public static final ASN1ObjectIdentifier ocspAccessMethod = id_ad_ocsp = X509ObjectIdentifiers.id_ad.branch("1").intern();
