                            ...
                            while (true) {
                                ...
                                while (oids.hasMoreElements()) {
                                    ...
                                    if (extension.getExtnValue() != null) {
                                        ...
                                        sb.append(") ");
                                        try {
                                            if (asn1ObjectIdentifier.equals(org.spongycastle.asn1.x509.X509Extension.reasonCode)) {
                                                sb.append(CRLReason.getInstance(ASN1Enumerated.getInstance(asn1InputStream.readObject())));
                                            }
                                            else if (asn1ObjectIdentifier.equals(org.spongycastle.asn1.x509.X509Extension.certificateIssuer)) {
