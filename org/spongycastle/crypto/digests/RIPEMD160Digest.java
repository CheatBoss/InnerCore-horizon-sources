...
public class RIPEMD160Digest extends GeneralDigest
{
    ...
    protected void processBlock() {
        ...
        final int n = this.RL(this.f1(h2, h3, h4) + h0 + this.X[0], 11) + h5;
        final int rl = this.RL(h3, 10);
        final int n2 = this.RL(this.f1(n, h2, rl) + h5 + this.X[1], 14) + h4;
        final int rl2 = this.RL(h2, 10);
        final int n3 = this.RL(this.f1(n2, n, rl2) + h4 + this.X[2], 15) + rl;
        ...
        final int n17 = this.RL(h0 + this.f5(h2, h3, h4) + this.X[5] + 1352829926, 8) + h5;
        final int rl17 = this.RL(h3, 10);
        final int n18 = this.RL(h5 + this.f5(n17, h2, rl17) + this.X[14] + 1352829926, 9) + h4;
        final int rl18 = this.RL(h2, 10);
        final int n19 = this.RL(h4 + this.f5(n18, n17, rl18) + this.X[7] + 1352829926, 9) + rl17;
        ...
        final int n33 = this.RL(rl14 + this.f2(n16, n15, rl16) + this.X[7] + 1518500249, 7) + rl15;
        final int rl33 = this.RL(n15, 10);
        final int n34 = this.RL(rl15 + this.f2(n33, n16, rl33) + this.X[4] + 1518500249, 6) + rl16;
        final int rl34 = this.RL(n16, 10);
        ...
        final int n49 = this.RL(rl30 + this.f4(n32, n31, rl32) + this.X[6] + 1548603684, 9) + rl31;
        final int rl49 = this.RL(n31, 10);
        final int n50 = this.RL(rl31 + this.f4(n49, n32, rl49) + this.X[11] + 1548603684, 13) + rl32;
        final int rl50 = this.RL(n32, 10);
        ...
        final int n65 = this.RL(rl46 + this.f3(n48, n47, rl48) + this.X[3] + 1859775393, 11) + rl47;
        final int rl65 = this.RL(n47, 10);
        final int n66 = this.RL(rl47 + this.f3(n65, n48, rl65) + this.X[10] + 1859775393, 13) + rl48;
        final int rl66 = this.RL(n48, 10);
        final int n67 = this.RL(rl48 + this.f3(n66, n65, rl66) + this.X[14] + 1859775393, 6) + rl65;
        ...
        final int n81 = this.RL(rl62 + this.f3(n64, n63, rl64) + this.X[15] + 1836072691, 9) + rl63;
        final int rl81 = this.RL(n63, 10);
        final int n82 = this.RL(rl63 + this.f3(n81, n64, rl81) + this.X[5] + 1836072691, 7) + rl64;
        final int rl82 = this.RL(n64, 10);
        final int n83 = this.RL(rl64 + this.f3(n82, n81, rl82) + this.X[1] + 1836072691, 15) + rl81;
        ...
        final int n97 = this.RL(rl78 + this.f4(n80, n79, rl80) + this.X[1] - 1894007588, 11) + rl79;
        ...
        final int n113 = this.RL(rl94 + this.f2(n96, n95, rl96) + this.X[8] + 2053994217, 15) + rl95;
        ...
        final int n129 = this.RL(rl110 + this.f5(n112, n111, rl112) + this.X[4] - 1454113458, 9) + rl111;
        final int rl129 = this.RL(n111, 10);
        ...
        final int n144 = this.RL(rl126 + this.f1(n128, n127, rl128) + this.X[12], 8) + rl127;
        final int rl146 = this.RL(n127, 10);
        ...
        final int h6 = this.H1;
        this.H1 = this.H2 + rl145 + rl160;
        this.H2 = this.H3 + rl143 + rl159;
        this.H3 = this.H4 + rl142 + (rl161 + rl159);
        this.H4 = this.H0 + (rl144 + rl142) + n158;
        this.H0 = rl162 + (n143 + h6);
        int n159 = 0;
        this.xOff = 0;
        while (true) {
            final int[] x = this.X;
