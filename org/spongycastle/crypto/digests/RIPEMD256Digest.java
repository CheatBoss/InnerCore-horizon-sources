...
public class RIPEMD256Digest extends GeneralDigest
{
    ...
    protected void processBlock() {
        ...
        final int f17 = this.F2(ff16, f16, f15, f14, this.X[7], 7);
        ...
        final int ff20 = this.FF3(f13, ff19, ff18, ff17, this.X[6], 9);
        ...
        final int f33 = this.F3(f29, ff35, f31, f30, this.X[3], 11);
        final int f34 = this.F3(f30, f33, ff35, f31, this.X[10], 13);
        final int f35 = this.F3(f31, f34, f33, ff35, this.X[14], 6);
        final int f36 = this.F3(ff35, f35, f34, f33, this.X[4], 7);
        ...
        final int ff36 = this.FF2(ff32, f32, ff34, ff33, this.X[15], 9);
        final int ff37 = this.FF2(ff33, ff36, f32, ff34, this.X[5], 7);
        final int ff38 = this.FF2(ff34, ff37, ff36, f32, this.X[1], 15);
        final int ff39 = this.FF2(f32, ff38, ff37, ff36, this.X[3], 11);
        ...
        final int f49 = this.F4(f45, f48, ff50, f46, this.X[1], 11);
        final int f50 = this.F4(f46, f49, f48, ff50, this.X[9], 12);
        final int f51 = this.F4(ff50, f50, f49, f48, this.X[11], 14);
        ...
        final int ff52 = this.FF1(ff48, ff51, f47, ff49, this.X[8], 15);
        final int ff53 = this.FF1(ff49, ff52, ff51, f47, this.X[6], 5);
        final int ff54 = this.FF1(f47, ff53, ff52, ff51, this.X[4], 8);
