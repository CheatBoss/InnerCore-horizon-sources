...
public class SHA224Digest extends GeneralDigest implements EncodableDigest
{
    ...
    protected void processBlock() {
        ...
        for (int j = 0; j < 8; ++j) {
            ...
            final int n5 = n + 1;
            final int n6 = h7 + (this.Sum1(n3) + this.Ch(n3, h5, h6) + SHA224Digest.K[n5] + this.X[n5]);
            final int n7 = h3 + n6;
            final int n8 = n6 + (this.Sum0(n4) + this.Maj(n4, h1, h2));
            final int n9 = n5 + 1;
            final int n10 = h6 + (this.Sum1(n7) + this.Ch(n7, n3, h5) + SHA224Digest.K[n9] + this.X[n9]);
            final int n11 = h2 + n10;
            final int n12 = n10 + (this.Sum0(n8) + this.Maj(n8, n4, h1));
            final int n13 = n9 + 1;
            final int n14 = h5 + (this.Sum1(n11) + this.Ch(n11, n7, n3) + SHA224Digest.K[n13] + this.X[n13]);
            final int n15 = h1 + n14;
            final int n16 = n14 + (this.Sum0(n12) + this.Maj(n12, n8, n4));
            final int n17 = n13 + 1;
            final int n18 = n3 + (this.Sum1(n15) + this.Ch(n15, n11, n7) + SHA224Digest.K[n17] + this.X[n17]);
            h8 = n4 + n18;
            h4 = n18 + (this.Sum0(n16) + this.Maj(n16, n12, n8));
            final int n19 = n17 + 1;
            final int n20 = n7 + (this.Sum1(h8) + this.Ch(h8, n15, n11) + SHA224Digest.K[n19] + this.X[n19]);
            h7 = n8 + n20;
            h3 = n20 + (this.Sum0(h4) + this.Maj(h4, n16, n12));
            final int n21 = n19 + 1;
            final int n22 = n11 + (this.Sum1(h7) + this.Ch(h7, h8, n15) + SHA224Digest.K[n21] + this.X[n21]);
            h6 = n12 + n22;
            h2 = n22 + (this.Sum0(h3) + this.Maj(h3, h4, n16));
            final int n23 = n21 + 1;
            final int n24 = n15 + (this.Sum1(h6) + this.Ch(h6, h7, h8) + SHA224Digest.K[n23] + this.X[n23]);
            h5 = n16 + n24;
