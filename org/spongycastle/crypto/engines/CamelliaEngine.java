...
public class CamelliaEngine implements BlockCipher
{
    ...
    private void camelliaF2(final int[] array, final int[] array2, int n) {
        final int n2 = array[0] ^ array2[n + 0];
        final int[] sbox4_4404 = CamelliaEngine.SBOX4_4404;
        final int n3 = sbox4_4404[n2 & 0xFF];
        final int[] sbox3_3033 = CamelliaEngine.SBOX3_3033;
        final int n4 = sbox3_3033[n2 >>> 8 & 0xFF];
        final int[] sbox2_0222 = CamelliaEngine.SBOX2_0222;
        final int n5 = sbox2_0222[n2 >>> 16 & 0xFF];
        final int[] sbox1_1110 = CamelliaEngine.SBOX1_1110;
        final int n6 = sbox1_1110[n2 >>> 24 & 0xFF] ^ (n3 ^ n4 ^ n5);
        final int n7 = array[1] ^ array2[n + 1];
        final int n8 = sbox1_1110[n7 & 0xFF];
        final int n9 = sbox4_4404[n7 >>> 8 & 0xFF];
        final int n10 = sbox3_3033[n7 >>> 16 & 0xFF];
        final int n11 = sbox2_0222[n7 >>> 24 & 0xFF];
        final int n12 = array[2];
        final int n13 = n9 ^ n8 ^ n10 ^ n11 ^ n6;
        array[2] = (n12 ^ n13);
        array[3] ^= (rightRotate(n6, 8) ^ n13);
        final int n14 = array[2] ^ array2[n + 2];
        final int[] sbox4_4405 = CamelliaEngine.SBOX4_4404;
        final int n15 = sbox4_4405[n14 & 0xFF];
        final int[] sbox3_3034 = CamelliaEngine.SBOX3_3033;
        final int n16 = sbox3_3034[n14 >>> 8 & 0xFF];
        final int[] sbox2_223 = CamelliaEngine.SBOX2_0222;
        final int n17 = sbox2_223[n14 >>> 16 & 0xFF];
        final int[] sbox1_1111 = CamelliaEngine.SBOX1_1110;
        final int n18 = sbox1_1111[n14 >>> 24 & 0xFF] ^ (n15 ^ n16 ^ n17);
        final int n19 = array2[n + 3] ^ array[3];
        n = sbox1_1111[n19 & 0xFF];
        final int n20 = sbox4_4405[n19 >>> 8 & 0xFF];
        final int n21 = sbox3_3034[n19 >>> 16 & 0xFF];
        final int n22 = sbox2_223[n19 >>> 24 & 0xFF];
        final int n23 = array[0];
        n = (n22 ^ (n ^ n20 ^ n21) ^ n18);
        array[0] = (n23 ^ n);
        array[1] ^= (n ^ rightRotate(n18, 8));
    }
