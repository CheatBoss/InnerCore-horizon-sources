...
public class CachedPowers
{
    ...
    static int getCachedPower(int n, final int n2, final int n3, final DiyFp diyFp) {
        n = ((int)Math.ceil((n2 - n + 64 - 1) * 0.30102999566398114) + 308 - 1) / 8;
        final CachedPower cachedPower = CachedPowers.CACHED_POWERS[n + 1];
