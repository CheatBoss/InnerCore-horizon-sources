...
public class Token
{
    ...
    public static boolean isValidToken(final int n) {
        return n >= -1 && n <= 164;
    }
    
    public static String keywordToName(final int n) {
        switch (n) {
            default: {
                switch (n) {
                    default: {
    ...
    public static String name(final int n) {
        return String.valueOf(n);
    }
    
    public static String typeToName(final int n) {
        switch (n) {
            default: {
