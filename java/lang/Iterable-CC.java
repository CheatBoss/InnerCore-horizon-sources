...
{
    public static void $default$forEach(final Iterable p0, final Consumer<?> p2) {
        // 
    ...
    public static Spliterator<Object> $default$spliterator(final Iterable iterable) {
        return Spliterators.spliteratorUnknownSize((Iterator<?>)iterable.iterator(), 0);
    }
}
