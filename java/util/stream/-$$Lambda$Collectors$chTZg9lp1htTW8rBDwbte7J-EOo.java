...
public final class -$$Lambda$Collectors$chTZg9lp1htTW8rBDwbte7J-EOo implements Function
{
    @Override
    public <V> Function<Object, V> andThen(final Function<?, ? extends V> p0) {
        // 
    ...
    public final Object apply(final Object o) {
        return Collectors.lambda$partitioningBy$57(this.f$0, (Collectors.Partition)o);
    }
    
    @Override
    public <V> Function<V, Object> compose(final Function<? super V, ?> function) {
        return Function-CC.$default$compose(function);
    }
}
