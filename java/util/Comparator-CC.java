...
{
    public static Comparator<Object> $default$reversed(final Comparator comparator) {
        return Collections.reverseOrder((Comparator<Object>)comparator);
    }
    
    public static Comparator<Object> $default$thenComparing(final Comparator p0, final Comparator<?> p2) {
        // 
    ...
    public static <U extends Comparable<? super U>> Comparator<Object> $default$thenComparing(final Comparator p0, final Function<?, ? extends U> p2) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    public static <U> Comparator<Object> $default$thenComparing(final Comparator p0, final Function<?, ? extends U> p2, final Comparator<? super U> p3) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    public static Comparator<Object> $default$thenComparingDouble(final Comparator p0, final ToDoubleFunction<?> p2) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    public static Comparator<Object> $default$thenComparingInt(final Comparator p0, final ToIntFunction<?> p2) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    public static Comparator<Object> $default$thenComparingLong(final Comparator p0, final ToLongFunction<?> p2) {
        // 
        // This method could not be decompiled.
        // 
        // Could not show original bytecode, likely due to the same error.
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> comparing(final Function<? super T, ? extends U> function) {
        function.getClass();
        return (Comparator<T>)new -$$Lambda$Comparator$SPB8K9Yj7Pw1mljm7LpasV7zxWw(function);
    }
    
    public static <T, U> Comparator<T> comparing(final Function<? super T, ? extends U> function, final Comparator<? super U> comparator) {
        function.getClass();
        comparator.getClass();
        return (Comparator<T>)new -$$Lambda$Comparator$KVN0LWz1D1wyrL2gs1CbubvLa9o(comparator, function);
    }
    
    public static <T> Comparator<T> comparingDouble(final ToDoubleFunction<? super T> toDoubleFunction) {
        toDoubleFunction.getClass();
        return (Comparator<T>)new -$$Lambda$Comparator$edSxqANnwdmzeJ1aMMcwJWE2wII(toDoubleFunction);
    }
    
    public static <T> Comparator<T> comparingInt(final ToIntFunction<? super T> toIntFunction) {
        toIntFunction.getClass();
        return (Comparator<T>)new -$$Lambda$Comparator$DNgpxUFZqmT4lOBzlVyPjWwvEvw(toIntFunction);
    }
    
    public static <T> Comparator<T> comparingLong(final ToLongFunction<? super T> toLongFunction) {
        toLongFunction.getClass();
        return (Comparator<T>)new -$$Lambda$Comparator$4V5k8aLimtS0VsEILEAqQ9UGZYo(toLongFunction);
    }
    ...
    public static <T> Comparator<T> nullsFirst(final Comparator<? super T> comparator) {
