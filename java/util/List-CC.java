...
{
    public static void $default$replaceAll(final List list, final UnaryOperator<Object> unaryOperator) {
    ...
    public static void $default$sort(final List p0, final Comparator<?> p2) {
        // 
        ...
        //     at com.strobel.assembler.metadata.MetadataHelper$6.visitClassType(MetadataHelper.java:1855)
    ...
    public static Spliterator<Object> $default$spliterator(final List list) {
        return Spliterators.spliterator((Collection<?>)list, 16);
    }
}
