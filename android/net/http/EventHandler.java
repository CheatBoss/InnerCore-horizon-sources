...
public interface EventHandler
{
    ...
    void certificate(final SslCertificate p0);
    
    void data(final byte[] p0, final int p1);
    
    void endData();
    
    void error(final int p0, final String p1);
    
    boolean handleSslErrorRequest(final SslError p0);
    
    void headers(final Headers p0);
    
    void status(final int p0, final int p1, final int p2, final String p3);
}
