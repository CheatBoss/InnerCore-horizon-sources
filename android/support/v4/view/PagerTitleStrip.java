...
public class PagerTitleStrip extends ViewGroup implements Decor
{
    ...
    private class PageListener extends DataSetObserver implements OnPageChangeListener, OnAdapterChangeListener
    {
        ...
        public void onChanged() {
            ...
            final float access$100 = PagerTitleStrip.this.mLastKnownPositionOffset;
            float access$101 = 0.0f;
            if (access$100 >= 0.0f) {
                access$101 = PagerTitleStrip.this.mLastKnownPositionOffset;
            }
            PagerTitleStrip.this.updateTextPositions(PagerTitleStrip.this.mPager.getCurrentItem(), access$101, true);
        }
