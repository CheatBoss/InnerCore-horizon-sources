...
class CircleImageView extends ImageView
{
    ...
    private class OvalShadow extends OvalShape
    {
        ...
        public void draw(final Canvas canvas, final Paint paint) {
            ...
            canvas.drawCircle(n, n2, (float)(this.mCircleDiameter / 2 + CircleImageView.this.mShadowRadius), this.mShadowPaint);
            canvas.drawCircle(n, n2, (float)(this.mCircleDiameter / 2), paint);
        }
    }
}
