...
class MaterialProgressDrawable extends Drawable implements Animatable
{
    ...
    private int evaluateColorChange(final float n, int n2, int intValue) {
        ...
        intValue = intValue;
        return (int)(((intValue & 0xFF) - n5) * n) + n5 | ((int)(((intValue >> 24 & 0xFF) - n2) * n) + n2 << 24 | (int)(((intValue >> 16 & 0xFF) - n3) * n) + n3 << 16 | (int)(((intValue >> 8 & 0xFF) - n4) * n) + n4 << 8);
    }
    ...
    private void setupAnimators() {
        ...
        final Animation mAnimation = new Animation() {
            public void applyTransformation(final float n, final Transformation transformation) {
                ...
                MaterialProgressDrawable.this.setRotation(n * 216.0f + MaterialProgressDrawable.this.mRotationCount / 5.0f * 1080.0f);
            }
        };
    ...
    private static class Ring
    {
        ...
        public void setInsets(final int n, final int n2) {
            ...
            if (this.mRingCenterRadius > 0.0 && n3 >= 0.0f) {
                ceil = n3 / 2.0f - this.mRingCenterRadius;
            }
            else {
