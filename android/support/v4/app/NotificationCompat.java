...
public class NotificationCompat
{
    ...
    public static class Action extends NotificationCompatBase.Action
    {
        ...
        public static final class WearableExtender implements Extender
        {
            ...
            private void setFlag(int mFlags, final boolean b) {
                if (b) {
                    mFlags |= this.mFlags;
                }
                else {
                    mFlags = (~mFlags & this.mFlags);
                }
                this.mFlags = mFlags;
            }
    ...
    public static class Builder
    {
        ...
        private void setFlag(int flags, final boolean b) {
    ...
    interface NotificationCompatImpl
    {
        ...
        NotificationCompatBase.UnreadConversation getUnreadConversationFromBundle(final Bundle p0, final NotificationCompatBase.Factory p1, final RemoteInputCompatBase.Factory p2);
    ...
    static class NotificationCompatImplApi21 extends NotificationCompatImplApi20
    {
        ...
        @Override
        public NotificationCompatBase.UnreadConversation getUnreadConversationFromBundle(final Bundle bundle, final NotificationCompatBase.Factory factory, final RemoteInputCompatBase.Factory factory2) {
