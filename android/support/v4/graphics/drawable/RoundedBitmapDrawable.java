...
public abstract class RoundedBitmapDrawable extends Drawable
{
    ...
    RoundedBitmapDrawable(final Resources resources, final Bitmap mBitmap) {
        ...
        if (this.mBitmap != null) {
            ...
            mBitmapShader = new BitmapShader(this.mBitmap, Shader$TileMode.CLAMP, Shader$TileMode.CLAMP);
        }
        else {
        ...
        this.mBitmapShader = mBitmapShader;
    }
    ...
    public void setCornerRadius(final float mCornerRadius) {
        ...
        Paint paint;
        Object mBitmapShader;
        if (isGreaterThanZero(mCornerRadius)) {
            paint = this.mPaint;
            mBitmapShader = this.mBitmapShader;
        }
        else {
            paint = this.mPaint;
            mBitmapShader = null;
