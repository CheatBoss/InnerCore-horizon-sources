...
public final class ColorUtils
{
    ...
    public static int XYZToColor(@FloatRange(from = 0.0, to = 95.047) double n, @FloatRange(from = 0.0, to = 100.0) double n2, @FloatRange(from = 0.0, to = 108.883) double n3) {
        ...
        n3 = (n * 0.0557 + n2 * -0.204 + 1.057 * n3) / 100.0;
        if (n4 > 0.0031308) {
    ...
    public static int calculateMinimumAlpha(@ColorInt final int n, @ColorInt final int n2, final float n3) {
        ...
        final double calculateContrast = calculateContrast(setAlphaComponent(n, 255), n2);
        final double n5 = n3;
        if (calculateContrast < n5) {
            return -1;
        }
        for (int n6 = 0, n7 = 0; n6 <= 10 && n4 - n7 > 1; ++n6) {
            final int n8 = (n7 + n4) / 2;
            if (calculateContrast(setAlphaComponent(n, n8), n2) < n5) {
                n7 = n8;
            }
            else {
                n4 = n8;
